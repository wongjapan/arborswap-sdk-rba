...
export class PairExternal {
  ...
  public constructor(tokenAmountA: TokenAmount, tokenAmountB: TokenAmount) {
    ...
    this.liquidityToken = new Token(
      ...
      PairExternal.getAddress(tokenAmounts[0].token, tokenAmounts[1].token),
      18,
      'Arbor-LPs',
      'Arbor LPs'
    )
  ...
  public getOutputAmount(inputAmount: TokenAmount): [TokenAmount, PairExternal] {
  ...
  public getInputAmount(outputAmount: TokenAmount): [TokenAmount, PairExternal] {
