...
export declare class PairExternal {
    ...
    getOutputAmount(inputAmount: TokenAmount): [TokenAmount, PairExternal];
    getInputAmount(outputAmount: TokenAmount): [TokenAmount, PairExternal];
