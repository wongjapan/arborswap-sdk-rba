    ...
    switch (trade.tradeType) {
      case exports.TradeType.EXACT_INPUT:
        if (etherIn) {
          ...
          methodName = pairType == exports.PairType.INTERNAL ? 'swapExactTokenForETH' : 'swapExactTokenForETHEx'; // (address token, uint amountIn, uint amountOutMin, address to, uint deadline)
