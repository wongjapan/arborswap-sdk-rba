...
var PairExternal = /*#__PURE__*/function () {
  ...
  PairExternal.getAddress = function getAddress(tokenA, tokenB) {
    ...
    if (((_PAIR_ADDRESS_CACHE = PAIR_ADDRESS_CACHE$1) === null || _PAIR_ADDRESS_CACHE === void 0 ? void 0 : _PAIR_ADDRESS_CACHE[key]) === undefined) {
      ...
      PAIR_ADDRESS_CACHE$1 = _extends({}, PAIR_ADDRESS_CACHE$1, (_extends2 = {}, _extends2[key] = address.getCreate2Address(EXTERNAL_FACTORY_ADDRESS_MAP[token0.chainId], solidity.keccak256(['bytes'], [solidity.pack(['address', 'address'], [token0.address, token1.address])]), EXTERNAL_CODE_HASH_MAP[token0.chainId]), _extends2));
    }
...
exports.Pair = Pair;
exports.PairExternal = PairExternal;
